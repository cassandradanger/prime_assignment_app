class Cohort < ActiveRecord::Base
  ...
  validates_presence_of :target_size, :earnest_application_code, :course
  validates_presence_of :prework_start, :classroom_start, :graduation, :applications_open, :applications_close
